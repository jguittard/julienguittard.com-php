...
class ConfigProviderTest extends TestCase
{
    ...
    public function testInvokeReturnsArray()
    {
        ...
        $this->assertArrayHasKey('templates', $cp());
    }
    ...
    public function testGetTemplatesReturnsPaths()
    {
        $this->assertArrayHasKey('paths', $this->configProvider->getTemplates());
    }
}
